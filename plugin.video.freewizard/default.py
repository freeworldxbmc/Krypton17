...
AddonTitle='Free Wizard'; wizardUrl='http://legionworldtv.com/master/'; 
SiteDomain='[COLOR red]Free[/COLOR]world [COLOR red]Ent[/COLOR]ert[COLOR red]ainment[/COLOR]'; TeamName='[COLOR red]Free[/COLOR]world [COLOR red]Mul[/COLOR]ti [COLOR red]Media[/COLOR] Wizard'; 
...
RequiredHostsUrl='http://legionworldtv.com/master/requiredhosts.py'
LinksUrl=wizardUrl+'links.txt'
#LinksUrl='http://legionworldtv.com/Wizard/links.txt'
...
def HELPWIZARD(name,url,description,filetype):
    ...
    if filetype=='splash':
        ...
        splash.do_My_TextSplash2(html,SplashBH,12,TxtColor='silver',Font='font12',BorderWidth=40,ImgexitBtn=ExitBH,colorDiffuse='silver'); 
        return
    if confirm.yesno(TeamName,"Would you like %s to "%SiteDomain,"Install your Add-On selection? "," "):
        ...
        dialog.ok("Success!","Installation Complete","   [COLOR silver]Brought To You By %s[/COLOR]"%SiteDomain)
