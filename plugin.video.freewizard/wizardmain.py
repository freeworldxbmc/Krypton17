...
#Define common.addon
addon_id='plugin.video.freewizard'; 
AddonTitle='Free Wizard'; 
# Global Stuff
...
def WIZARDSTATUS(url):
    ...
    for name,url,iconimage,fanart,description,filetype in match: header="[B][COLOR silver]"+name+"[/B][/COLOR]"; msg=(description); TextBoxes(header,msg)
